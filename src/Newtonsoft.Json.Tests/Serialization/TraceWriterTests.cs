    ...
    public class TraceWriterTests : TestFixtureBase
    {
        ...
        public void DiagnosticsTraceWriterTest()
        {
            ...
            try
            {
                ...
                StringAssert.AreEqual(@"Mapbox.Json Verbose: 0 : Verbose!
Mapbox.Json Information: 0 : Info!
Mapbox.Json Warning: 0 : Warning!
Mapbox.Json Error: 0 : Error!
", sw.ToString());
            }
            finally
            {
...
[
  ...
  $('#element')
        ...
        public void MemoryTraceWriterSerializeTest()
        {
            ...
            // 2012-11-11T12:08:42.761 Info Started serializing Mapbox.Json.Tests.Serialization.Staff. Path ''.
            // 2012-11-11T12:08:42.785 Info Started serializing System.DateTime with converter Mapbox.Json.Converters.JavaScriptDateTimeConverter. Path 'StartDate'.
            // 2012-11-11T12:08:42.791 Info Finished serializing System.DateTime with converter Mapbox.Json.Converters.JavaScriptDateTimeConverter. Path 'StartDate'.
            // 2012-11-11T12:08:42.797 Info Started serializing System.Collections.Generic.List`1[System.String]. Path 'Roles'.
            // 2012-11-11T12:08:42.798 Info Finished serializing System.Collections.Generic.List`1[System.String]. Path 'Roles'.
            // 2012-11-11T12:08:42.799 Info Finished serializing Mapbox.Json.Tests.Serialization.Staff. Path ''.
            ...
            string json = @"Serialized JSON: 
{
  ...
  ""Roles"": [
    ""Administrator""
        ...
        public void Serialize()
        {
            ...
            Assert.AreEqual("Started serializing Mapbox.Json.Tests.Serialization.TraceTestObject. Path ''.", traceWriter.TraceRecords[0].Message);
            ...
            Assert.AreEqual("Finished serializing Mapbox.Json.Tests.Serialization.TraceTestObject. Path ''.", traceWriter.TraceRecords[9].Message);
  ...
  ""Double"": 1.1
            ...
            Assert.AreEqual("Started deserializing Mapbox.Json.Tests.Serialization.TraceTestObject. Path 'IntList', line 2, position 12.", traceWriter.TraceRecords[0].Message);
            ...
            Assert.IsTrue(traceWriter.TraceRecords[10].Message.StartsWith("Finished deserializing Mapbox.Json.Tests.Serialization.TraceTestObject. Path ''"));
  ...
  ""Double"": 1.1
        ...
        public void ErrorDeserializing()
        {
            ...
            Assert.AreEqual("Started deserializing Mapbox.Json.Tests.Serialization.IntegerTestClass. Path 'Integer', line 1, position 11.", traceWriter.TraceRecords[0].Message);

            Assert.AreEqual(TraceLevel.Error, traceWriter.TraceRecords[1].Level);
            Assert.AreEqual("Error deserializing Mapbox.Json.Tests.Serialization.IntegerTestClass. Could not convert string to integer: hi. Path 'Integer', line 1, position 15.", traceWriter.TraceRecords[1].Message);
        }
        ...
        public void ErrorDeserializingNested()
        {
            ...
            Assert.AreEqual(TraceLevel.Info, traceWriter.TraceRecords[0].Level);
            Assert.AreEqual("Started deserializing Mapbox.Json.Tests.Serialization.TraceTestObject. Path 'IntList', line 1, position 11.", traceWriter.TraceRecords[0].Message);
        ...
        public void SerializeDictionarysWithPreserveObjectReferences()
        {
            ...
            Assert.IsTrue(traceWriter.TraceRecords.Any(r => r.Message == "Writing object reference Id '1' for Mapbox.Json.Tests.Serialization.PreserveReferencesHandlingTests+CircularDictionary. Path ''."));
            Assert.IsTrue(traceWriter.TraceRecords.Any(r => r.Message == "Writing object reference Id '2' for Mapbox.Json.Tests.Serialization.PreserveReferencesHandlingTests+CircularDictionary. Path 'other'."));
            Assert.IsTrue(traceWriter.TraceRecords.Any(r => r.Message == "Writing object reference to Id '1' for Mapbox.Json.Tests.Serialization.PreserveReferencesHandlingTests+CircularDictionary. Path 'self'."));
        }
  ...
  ""self"": {
    ""$ref"": ""1""
            ...
            Assert.IsTrue(traceWriter.TraceRecords.Any(r => r.Message == "Read object reference Id '1' for Mapbox.Json.Tests.Serialization.PreserveReferencesHandlingTests+CircularDictionary. Path 'other', line 3, position 10."));
            Assert.IsTrue(traceWriter.TraceRecords.Any(r => r.Message == "Read object reference Id '2' for Mapbox.Json.Tests.Serialization.PreserveReferencesHandlingTests+CircularDictionary. Path 'other.blah', line 5, position 11."));
            Assert.IsTrue(traceWriter.TraceRecords.Any(r => r.Message.StartsWith("Resolved object reference '1' to Mapbox.Json.Tests.Serialization.PreserveReferencesHandlingTests+CircularDictionary. Path 'self'")));
        }
        ...
        public void SerializeConverter()
        {
            ...
            Assert.AreEqual("Started serializing System.DateTime with converter Mapbox.Json.Converters.JavaScriptDateTimeConverter. Path ''.", traceWriter.TraceRecords[1].Message);
            Assert.AreEqual("Finished serializing System.DateTime with converter Mapbox.Json.Converters.JavaScriptDateTimeConverter. Path '[0]'.", traceWriter.TraceRecords[2].Message);
        ...
        public void DeserializeConverter()
        {
            ...
            Assert.AreEqual("Started deserializing System.DateTime with converter Mapbox.Json.Converters.JavaScriptDateTimeConverter. Path '[0]', line 1, position 10.", traceWriter.TraceRecords[1].Message);
            Assert.AreEqual("Finished deserializing System.DateTime with converter Mapbox.Json.Converters.JavaScriptDateTimeConverter. Path '[0]', line 1, position 23.", traceWriter.TraceRecords[2].Message);
    ...
    },
    {
      ...
      ""MinorRevision"": 4
        ...
        public void DeserializeMissingMember()
        {
            ...
            Assert.AreEqual("Started deserializing Mapbox.Json.Tests.TestObjects.Person. Path 'MissingMemberProperty', line 1, position 25.", traceWriter.TraceRecords[0].Message);
            Assert.AreEqual("Could not find member 'MissingMemberProperty' on Mapbox.Json.Tests.TestObjects.Person. Path 'MissingMemberProperty', line 1, position 25.", traceWriter.TraceRecords[1].Message);
            Assert.IsTrue(traceWriter.TraceRecords[2].Message.StartsWith("Finished deserializing Mapbox.Json.Tests.TestObjects.Person. Path ''"));
        }
  ...
  ""MissingMemberProperty"": null
        ...
        public void PublicParameterizedConstructorWithPropertyNameConflictWithAttribute()
        {
            ...
            Assert.AreEqual("Deserializing Mapbox.Json.Tests.TestObjects.PublicParameterizedConstructorWithPropertyNameConflictWithAttribute using creator with parameters: name. Path 'name', line 1, position 6.", traceWriter.TraceRecords[0].Message);
        }
        ...
        public void ShouldSerializeTestClass()
        {
            ...
            Assert.AreEqual("ShouldSerialize result for property 'Name' on Mapbox.Json.Tests.Serialization.ShouldSerializeTestClass: True. Path ''.", traceWriter.TraceRecords[1].Message);
            ...
            Assert.AreEqual("ShouldSerialize result for property 'Name' on Mapbox.Json.Tests.Serialization.ShouldSerializeTestClass: False. Path ''.", traceWriter.TraceRecords[1].Message);
            Assert.AreEqual(TraceLevel.Verbose, traceWriter.TraceRecords[1].Level);
        }
        ...
        public void SpecifiedTest()
        {
            ...
            Assert.AreEqual("Started serializing Mapbox.Json.Tests.Serialization.SpecifiedTestClass. Path ''.", traceWriter.TraceRecords[0].Message);
            Assert.AreEqual("IsSpecified result for property 'Name' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass: False. Path ''.", traceWriter.TraceRecords[1].Message);
            Assert.AreEqual("IsSpecified result for property 'Weight' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass: False. Path 'Age'.", traceWriter.TraceRecords[2].Message);
            Assert.AreEqual("IsSpecified result for property 'Height' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass: False. Path 'Age'.", traceWriter.TraceRecords[3].Message);
            Assert.AreEqual("IsSpecified result for property 'FavoriteNumber' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass: False. Path 'Age'.", traceWriter.TraceRecords[4].Message);
            Assert.AreEqual("Finished serializing Mapbox.Json.Tests.Serialization.SpecifiedTestClass. Path ''.", traceWriter.TraceRecords[5].Message);
  ...
  ""Age"": 27
            ...
            Assert.AreEqual("Started deserializing Mapbox.Json.Tests.Serialization.SpecifiedTestClass. Path 'Age', line 2, position 8.", traceWriter.TraceRecords[0].Message);
            Assert.IsTrue(traceWriter.TraceRecords[1].Message.StartsWith("Finished deserializing Mapbox.Json.Tests.Serialization.SpecifiedTestClass. Path ''"));
  ...
  ""FavoriteNumber"": 23
            ...
            Assert.AreEqual("Started deserializing Mapbox.Json.Tests.Serialization.SpecifiedTestClass. Path 'Name', line 2, position 9.", traceWriter.TraceRecords[0].Message);
            Assert.AreEqual("IsSpecified for property 'Name' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass set to true. Path 'Name', line 2, position 17.", traceWriter.TraceRecords[1].Message);
            Assert.AreEqual("IsSpecified for property 'Weight' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass set to true. Path 'Weight', line 4, position 13.", traceWriter.TraceRecords[2].Message);
            Assert.AreEqual("IsSpecified for property 'Height' on Mapbox.Json.Tests.Serialization.SpecifiedTestClass set to true. Path 'Height', line 5, position 13.", traceWriter.TraceRecords[3].Message);
            Assert.IsTrue(traceWriter.TraceRecords[4].Message.StartsWith("Finished deserializing Mapbox.Json.Tests.Serialization.SpecifiedTestClass. Path ''"));
